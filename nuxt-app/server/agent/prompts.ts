...
- В needs сохраняй транспортные пожелания ВМЕСТЕ с городом, если пользователь его назвал: «во Владивосток на ж/д», «обратно на самолёте», «до Бангкока автобусом». Это нужно, чтобы транспорт назначили только на нужный перегон.
